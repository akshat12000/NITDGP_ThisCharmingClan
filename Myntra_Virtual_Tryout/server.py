...
def empty(a):
    pass
cv2.namedWindow("Virtual Tryon")
cv2.resizeWindow("Virtual Tryon",640,240)
cv2.createTrackbar("Blue","Virtual Tryon",0,255,empty)
cv2.createTrackbar("Green", "Virtual Tryon", 0, 255, empty)
cv2.createTrackbar("Red", "Virtual Tryon", 0, 255, empty)
...
while True:
    ...
    for face in faces:
        ...
        a =cv2.getTrackbarPos("Blue", "Virtual Tryon")
        q =cv2.getTrackbarPos("Green", "Virtual Tryon")
        w =cv2.getTrackbarPos("Red", "Virtual Tryon")
        imgColor[:] = a,q,w
        ...
        cv2.imshow("Virtual Tryon", imgColor)
